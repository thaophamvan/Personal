<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuaTrucBan.aspx.cs" Inherits="PI.Web.Pages.SuaTrucBan" %>
            ...
            <tr>
              ...
              <tr>
                <td>
                    Từ ngày:</td>
                <td>
                    <asp:TextBox ID="txtTuNgay" runat="server" ReadOnly = "true"></asp:TextBox>
             ...
             <tr>
                <td>
                    Đến ngày:</td>
                <td>
                    <asp:TextBox ID="txtDenNgay" runat="server" ReadOnly = "true"></asp:TextBox>
                    <img src="/IMG/calender.png" />
            </tr>
             <tr>
                <td>
