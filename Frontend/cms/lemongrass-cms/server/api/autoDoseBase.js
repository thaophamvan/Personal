...
class autoDoseBase extends baseApi {
  getDetergent(req, res) {
    apiAuth.checkAuthentication(req, res, () => {
      ...
      if (country && pnc) {
        const selector = this.buildSelectorForAutoDose(type, country.toUpperCase(), pnc)
        ...
        common.constructReponseFailed(res, 'Need define country and PNC in query',
          'Need define country and PNC in query')
      }
    })
  }
