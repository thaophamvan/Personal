...
import { GOOLE_MAP_API } from '../constants/index';
...
export const createScriptTagForGoogleApi = (callback) => {
  ...
  if (callback) {
    googleTag.addEventListener('load', callback);
  }
...
export function showFooter()  {
  document.querySelector(".js_footer").classList.remove("hidden");
}