...
const UnAuthenticated = ({ baseUrl, authenticationLink, loginLink, logoutLink,
    ...
    <div id="diseMenu" className="bn_header-profile">
      <div className="bn_header-account">
        ...
        >
          ...
          <span id="accountLabel" className="bn_header-account bn_header-account--label">Logga In</span>
        </a>
      </div>
    </div>
  );
...
UnAuthenticated.defaultProps = defaultProps;
